...
document.getElementById('pdfBtn').onclick = () => {
    ...
    doc.text(`Date: ${now.toLocaleDateString('fr-FR')} ${now.toLocaleTimeString('fr-FR')} | Devise: Fbu`, 14, 24);
    ...
    const splitMots = doc.splitTextToSize(`Arrete le present bon de commande a la somme de : ${motsMaj} (${formatFbu(totalCost)}).`, 182);
